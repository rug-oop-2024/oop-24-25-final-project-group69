...
class Dataset(Artifact):
    """
    Represents a dataset artifact, extending the Artifact
    class with specific methods
    for handling datasets stored as CSVs.

    Inherits from:
        Artifact: The base class for artifacts, with
        additional dataset-specific functionality.
    """
    ...
    def read(self) -> pd.DataFrame:
        ...
        Returns:
            pd.DataFrame: The data stored in the dataset,
